...
def compute_tfm_common_source(worker_id, fmc_3d, tfm_constructor, time_vector_us, signal_progress, gen_index):
    # Create a TFM image using the A-scans from just one source point:
