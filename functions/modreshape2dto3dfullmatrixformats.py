...
def reshape_2d_dnplusgt_to_3d_dgt(displacements_2d_dnplusgt):
    """
    Reshape a full matrix of displacement measurements from 2D numpy format numpy[dn+g,t] to 3D numpy format numpy[d,g,t]
    ...
    """
    # Measure original 2D array shape:
...
def reshape_2d_tdnplusg_to_3d_dgt(displacements_2d_tdnplusg):
    """
    Reshape a full matrix of displacement measurements from 2D numpy format numpy[t,dn+g] to 3D numpy format numpy[d,g,t].
    ...
    :return: The full matrix of displacement measurements in 3D format numpy[d,g,t].
    """
    # Transpose numpy[t,dn+g] format to give numpy[dn+g,t] format.  Then pass transposed array to function that reshapes
    # numpy[dn+g,t] format to numpy[d,g,t] format:
    displacements_3d_dgt = reshape_2d_dnplusgt_to_3d_dgt(displacements_2d_tdnplusg.T)
