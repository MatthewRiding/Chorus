...
def calculate_travel_times_head_wave_to_pixels_subcrit_masked(x_grid_m, z_grid_m, x_elements_m, v_L_mpers, v_T_mpers,
                                                              v_LSAW_mpers=None):
    ...
    times_head_wave_to_pixel = calculate_travel_times_head_wave_to_pixels(x_grid_m, z_grid_m, x_elements_m,
                                                                          v_L_mpers, v_T_mpers, v_LSAW_mpers)
