...
def calculate_direct_ray_angles_radians(x_grid_m, z_grid_m, x_elements_m):
    ...
    for element_index, x_element in enumerate(x_elements_m):
        ...
        adjacent_m = z_grid_m
        angles_rays_all_pixels_all_el_radians[element_index, :, :] = np.arctan2(opposite_m, adjacent_m)

    return angles_rays_all_pixels_all_el_radians

def calculate_direct_ray_angles_degrees(x_grid_m, z_grid_m, x_elements_m):
    angles_direct_rays_all_pixels_all_el_radians = calculate_direct_ray_angles_radians(x_grid_m, z_grid_m, x_elements_m)
