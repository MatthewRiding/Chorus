...
################################################################################
## Form generated from reading UI file 'dialog_tfm_parameters_fmclp_wavesets.ui'
##
...
class Ui_dialog_tfm_parameters_fmclp(object):
    def setupUi(self, dialog_tfm_parameters_fmclp):
        ...
        self.doubleSpinBox_grid_size_x_mm.setValue(15.000000000000000)
        ...
        self.doubleSpinBox_grid_size_z_mm.setValue(10.000000000000000)
        ...
        sizePolicy1.setHeightForWidth(self.doubleSpinBox_v_L_ms.sizePolicy().hasHeightForWidth())
        self.doubleSpinBox_v_L_ms.setSizePolicy(sizePolicy1)
        ...
        sizePolicy1.setHeightForWidth(self.doubleSpinBox_v_T_ms.sizePolicy().hasHeightForWidth())
        self.doubleSpinBox_v_T_ms.setSizePolicy(sizePolicy1)
        ...
        self.comboBox_wave_set = QComboBox(self.groupBox)
        self.comboBox_wave_set.setObjectName(u"comboBox_wave_set")
        sizePolicy1.setHeightForWidth(self.comboBox_wave_set.sizePolicy().hasHeightForWidth())
        self.comboBox_wave_set.setSizePolicy(sizePolicy1)
        self.comboBox_wave_set.setFont(font2)

        self.formLayout_6.setWidget(0, QFormLayout.FieldRole, self.comboBox_wave_set)
        ...
        self.verticalLayout_2.addLayout(self.hlayout_main)
    ...
    def retranslateUi(self, dialog_tfm_parameters_fmclp):
        ...
        self.groupBox.setTitle(QCoreApplication.translate("dialog_tfm_parameters_fmclp", u"Wave set :", None))
