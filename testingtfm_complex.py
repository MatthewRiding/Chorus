...
image_complex, fmc_3d_filtered = compute_tfm_complex('', fmc_3d_detrend, tfm_constructor, time_vector_us,
                                                           signal_progress)
...
ax_1.set_title(f'{tfm_constructor.wave_set_string} sub-crit, {tfm_constructor.band_min_MHz} - {tfm_params.band_max_MHz}MHz',
               fontsize=16)
